...
function App() {
  ...
  const loadProjects = async () => {
    try {
      ...
      setError(tErrors('projects.loadFailed'))
    } finally {
      setLoading(false)
    }
  }
  ...
  const handleProjectClick = async (project: Project) => {
    try {
      ...
      setError(tErrors('sessions.loadFailed'))
    } finally {
      setLoading(false)
    }
  }
            ...
            <div className="w-full max-w-4xl">
              ...
              >
                <h1 className="text-4xl font-bold tracking-tight">
                  ...
                  <span className="text-[#DC7F4D]">{t('welcome.title.tron')}</span>
                </h1>
              </motion.div>
                ...
                >
                  ...
                  >
                    <div className="h-full flex flex-col items-center justify-center p-8">
                      ...
                      <h2 className="text-xl font-semibold">{t('navigation.ccAgents.title')}</h2>
                    </div>
                  </Card>
                </motion.div>
                ...
                >
                  ...
                  >
                    <div className="h-full flex flex-col items-center justify-center p-8">
                      ...
                      <h2 className="text-xl font-semibold">{t('navigation.ccProjects.title')}</h2>
                    </div>
                  </Card>
                </motion.div>
              </div>
                ...
                <div className="mb-4 flex items-start justify-between">
                  <div>
                    ...
                    <p className="mt-1 text-sm text-muted-foreground">
                      {t('projects.description.browse')}
                    </p>
                  </div>
                  {!selectedProject && (
                    <Button onClick={handleNewSession} size="default" className="!pr-6 mt-2">
                      <Plus className="mr-2 h-4 w-4" />
                      {t('button.newClaudeSession')}
                    </Button>
                  )}
                </div>
              </motion.div>
                      ...
                      {projects.length > 0 ? (
                        ...
                        <div className="py-8 text-center">
                          <p className="text-sm text-muted-foreground">
                            {t('projects.message.noProjectsFound')}
                          </p>
                        </div>
                      )}
                    </motion.div>
